...
async def imageflow_demo(tracker, predictor, vis_folder, current_time, args, path_video, cam_id):
...
def multicam(predictor, vis_folder, current_time, args):
...
async def main(exp, args):
    ...
    if args.demo == "image" or args.demo == "images":
        ...
        multicam(predictor, vis_folder, current_time, args)
    else:
